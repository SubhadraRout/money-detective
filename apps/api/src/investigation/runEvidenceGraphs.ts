...
console.log(
  "       MONEY DETECTIVE EVIDENCE GRAPH"
);
...
console.log(
  `Investigation graphs: ${graphs.length}`
);
...
console.log(
  `Average nodes/case:   ${output.summary.averageNodesPerGraph.toFixed(
    2
  )}`
);

console.log(
  `Average edges/case:   ${output.summary.averageEdgesPerGraph.toFixed(
    2
  )}`
);
...
if (graphs.length > 0) {
  ...
  console.log(
    `Refunds:             ₹${first.financialFlow.totalRefundAmount.toFixed(
      2
    )}`
  );

  console.log(
    `Fees:                ₹${first.financialFlow.totalFees.toFixed(
      2
    )}`
  );

  console.log(
    `Taxes:               ₹${first.financialFlow.totalTaxes.toFixed(
      2
    )}`
  );
...
console.log(
  "Evidence graph generation complete."
);
