...
export function detectUnexplainedAdjustments(
  ...
  for (const settlement of dataset.settlements) {
    ...
    candidates.push({
      ...
      potentialLeakage:
        Math.abs(settlement.adjustments),
      evidence: [
        paymentEvidence(
          payment,
          "amount",
        ...
        settlementEvidence(
          settlement,
          "adjustments",
          `Settlement contains an adjustment of ${settlement.adjustments}.`
        ),
        settlementEvidence(
          settlement,
          "netAmount",
      ...
      deterministicReason:
        `Settlement ${settlement.settlementId} contains an unexplained adjustment of ${settlement.adjustments}.`,
    });
  }
