...
import type {
  RecoveryPlan,
} from "../recovery/recoveryEngine.js";
...
console.log(
  "     MONEY DETECTIVE RECOVERY VERIFY"
);
console.log(
  "========================================"
);
...
console.log(
  `Recovery plans:       ${verifications.length}`
);
...
console.log(
  `Verified recovery:    ${money(
    totalVerifiedRecovery
  )}`
);

console.log(
  `Remaining exposure:   ${money(
    totalRemainingExposure
  )}`
);
...
console.log(
  `Partially recovered:  ${partiallyRecovered}`
);

console.log(
  `Not recovered:        ${notRecovered}`
);
...
console.log(
  `Verification results written to: ${outputPath}`
);
